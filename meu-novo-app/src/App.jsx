  ...
  <header style={{ 
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <nav style={{ marginTop: '20px' }}>
        <ul style={{ display: 'flex', justifyContent: 'center', gap: '25px', listStyle: 'none', padding: 0, fontWeight: 'bold', fontSize: '0.8rem' }}>
...
function App() {
  ...
  return (
    <div style={{ backgroundColor: '#1a1a1a', color: 'white', fontFamily: 'sans-serif', minHeight: '100vh' }}>
      <Header />
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        <section id="noticias">
          <ExpandableSection 
            title="NOTÍCIAS" 
            shortText="A IA está mudando a produtividade nas IDEs." 
            fullText="A integração profunda da inteligência artificial diretamente nos editores de código está permitindo que desenvolvedores foquem na lógica de alto nível, automatizando tarefas repetitivas e sugerindo refatorações complexas em tempo real." 
          />
        </section>
        
        <div id="ead-futuro" style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', margin: '40px 0' }}>
          <ExpandableSection isCard title="EAD" shortText="Sua sala de aula em qualquer lugar." fullText="Nossa plataforma utiliza tecnologia de streaming de baixa latência para garantir que você assista às aulas sem interrupções, em qualquer dispositivo." />
          <ExpandableSection isCard title="Conexão" shortText="Onde o talento encontra a oportunidade." fullText="Mais que um curso, somos uma ponte para startups e empresas de tecnologia que buscam talentos lapidados em nossa metodologia prática." />
        </div>
          ...
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '15px' }}>
              ...
              <div onClick={() => setIsAnnual(!isAnnual)} style={{ 
                width: '50px', height: '26px', background: '#007bff', borderRadius: '15px', position: 'relative', cursor: 'pointer' 
              }}>
                <div style={{ 
                  width: '20px', height: '20px', background: 'white', borderRadius: '50%', position: 'absolute', top: '3px', 
                  left: isAnnual ? '27px' : '3px', transition: '0.3s' 
                }} />
              </div>
              <span>Anual <small style={{ color: '#10b981' }}>-20% OFF</small></span>
            </div>
          </div>
      ...
      <footer style={{ background: '#111', color: 'gray', padding: '30px', textAlign: 'center', borderTop: '1px solid #333' }}>
        ...
        <p style={{ marginTop: '10px' }}>
          Desenvolvido por: <strong style={{ color: '#007bff' }}>Wendel Silva</strong>
        </p>
        <p style={{ fontSize: '0.8rem', opacity: 0.6 }}>djwendelrj@gmail.com</p>
      </footer>
    </div>
  );
}
